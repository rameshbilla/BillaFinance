                     ...
                     <div class="flex items-center gap-2">
                       <span *ngIf="isLoanReminderDue(loan)" class="text-[8px] font-black px-2 py-0.5 bg-orange-500 text-white rounded-md uppercase animate-pulse">Reminder Due</span>
                        <div class="flex items-center gap-2">
                         ...
                         <button (click)="$event.stopPropagation(); onSendReminder.emit({loan, type: 'whatsapp'})" class="w-7 h-7 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center transition-all hover:scale-110 shadow-lg shadow-green-500/30" title="Send WhatsApp">
                         ...
                         <button (click)="$event.stopPropagation(); onSendReminder.emit({loan, type: 'sms'})" class="w-7 h-7 bg-blue-500 hover:bg-blue-600 rounded-full flex items-center justify-center transition-all hover:scale-110 shadow-lg shadow-blue-500/30" title="Send SMS">
...
export class LoanManagementComponent implements OnInit {
  ...
  @Output() onSendReminder = new EventEmitter<{loan: InterestScheme, type: 'whatsapp' | 'sms'}>();
